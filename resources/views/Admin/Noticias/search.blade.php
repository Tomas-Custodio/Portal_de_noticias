    ...
    <section class="max-w-6xl mx-auto px-4 py-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            @forelse ($resultados as $noticia)
                ...
                <a href="{{ route('noticias.detalhes', $noticia->slug) }}" class="bg-white rounded-xl shadow hover:shadow-lg transition overflow-hidden flex flex-col">
            ...
            @empty
                <div class="col-span-full text-center py-16">
                    ...
                    <a href="{{ route('noticias.home') }}" class="text-blue-600 hover:underline text-sm mt-3 inline-block">
                        ← Voltar às notícias
                    </a>
                </div>
            @endforelse
