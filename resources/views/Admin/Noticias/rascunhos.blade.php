...
<div class="mx-auto max-w-7xl">
    ...
    <div class="mb-10">
        ...
        <div class="mb-5 flex items-center gap-2 text-sm">
            ...
            <span class="text-slate-300">/</span>
            <span class="font-medium text-slate-600">Rascunhos</span>
        </div>
        ...
        <div class="flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
            ...
            <div>
                ...
                <div class="mb-4 flex items-center gap-3">
                    ...
                    <div
                        class="flex h-12 w-12 items-center justify-center rounded-2xl bg-amber-500 text-white shadow-lg shadow-amber-500/20"
                    >
                ...
                <p class="mt-3 max-w-2xl text-sm leading-6 text-slate-500">
                    Notícias guardadas como rascunho. Estas notícias
                    não aparecem no portal público até serem publicadas.
                </p>
            ...
            <span class="inline-flex self-start rounded-full bg-slate-100 px-4 py-2 text-xs font-bold uppercase tracking-wider text-slate-600 md:self-auto">
                {{ $rascunhos->total() }}
                {{ $rascunhos->total() === 1 ? 'rascunho' : 'rascunhos' }}
            </span>
    ...
    <div class="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
                    ...
                    <div class="group flex flex-col gap-4 p-5 transition hover:bg-slate-50/70 sm:flex-row sm:items-center sm:justify-between sm:p-6">
                        ...
                        <div class="flex min-w-0 items-center gap-4">
                            ...
                            <div class="min-w-0">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="inline-flex items-center gap-1.5 rounded-full bg-amber-50 px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider text-amber-600">
                        ...
                        <div class="flex shrink-0 flex-wrap gap-2">
                            ...
                            <form action="{{ route('noticias.delete', $noticia->id) }}"
                                  method="POST"
                                  class="inline"
                                  onsubmit="return confirm('Tem certeza que deseja eliminar este rascunho?');">
        ...
        @else
            ...
            <div class="px-6 py-20 text-center">
                ...
                <div class="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-2xl bg-amber-50 text-amber-500">
                ...
                <p class="mx-auto mt-2 max-w-md text-sm leading-6 text-slate-500">
                    Não existem notícias guardadas como rascunho.
                </p>
