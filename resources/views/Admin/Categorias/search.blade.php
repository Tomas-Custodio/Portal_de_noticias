...
@section('title', 'Pesquisa de categorias')
@section('page_title', 'Pesquisa de categorias')
                ...
                <div class="hidden overflow-x-auto md:block">
                    ...
                    <table class="w-full min-w-[700px]">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            ...
                            @forelse($resultado as $categoria)

                                @php
                                    $total = $categoria->noticias_count ?? 0;
                                @endphp
                                ...
                                <tr class="group transition-colors duration-200 hover:bg-slate-50">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-indigo-50 text-sm font-bold text-indigo-600 transition-colors group-hover:bg-indigo-600 group-hover:text-white">
                                    ...
                                    <td colspan="4" class="px-6 py-20 text-center">
                                        ...
                                        <div class="mx-auto max-w-sm">
                                            ...
                                            <p class="mt-2 text-sm text-slate-500">
                                                Não encontrámos categorias com
                    ...
                    @forelse($resultado as $categoria)
                        ...
                        <div class="p-5 transition-colors hover:bg-slate-50">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-indigo-50 text-sm font-bold text-indigo-600">
                                    {{ strtoupper(substr($categoria->nome, 0, 1)) }}
                                </div>
        ...
        @else
            ...
            <section class="rounded-2xl border border-dashed border-slate-200 bg-white p-12 text-center shadow-sm">
                ...
                <p class="mx-auto mt-2 max-w-md text-sm leading-6 text-slate-500">
                    Escreve o nome de uma categoria no campo acima
