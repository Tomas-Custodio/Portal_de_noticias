        ...
        >
            ...
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                ...
                <div class="group/search relative flex-1">
                    ...
                    <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3 text-slate-400 transition group-focus-within/search:text-orange-600">
                    ...
                    <input
                        ...
                        autocomplete="off"
                        autofocus
                        class="w-full rounded-xl border border-slate-200 bg-slate-50 py-3 pl-10 pr-4 text-sm text-slate-800 outline-none transition duration-200 placeholder:text-slate-400 hover:border-slate-300 hover:bg-white focus:border-orange-500 focus:bg-white focus:ring-4 focus:ring-orange-500/10"
                    >
                ...
                <button
                    type="submit"
                    class="group inline-flex items-center justify-center gap-2 rounded-xl bg-orange-500 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-orange-500/20 transition duration-200 hover:bg-orange-600 hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-orange-500/30 active:scale-[0.98]"
                >
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-slate-400">
                    ...
                    @if($termo)
                        ...
                        para "<span class="font-semibold text-orange-600">{{ $termo }}</span>"
                                    ...
                                    <div class="mx-auto max-w-sm">
                                        ...
                                        @if($termo)
                                            ...
                                            <p class="mt-2 text-sm text-slate-500">
                                                ...
                                                "<span class="font-semibold text-orange-600">{{ $termo }}</span>".
                                            </p>

                                            <a
                                                href="{{ route('users.search') }}"
                                                class="mt-5 inline-flex items-center gap-1.5 rounded-xl border border-slate-200 bg-white px-4 py-2 text-xs font-semibold text-slate-600 transition hover:border-orange-200 hover:bg-orange-50 hover:text-orange-600"
                                            >
                                        ...
                                        @else
                                            ...
                                            <p class="mt-2 text-sm text-slate-500">
                                                Escreve um nome ou email no campo acima para encontrar utilizadores.
                                            </p>
                    ...
                    <div class="px-5 py-12 text-center text-sm text-slate-500">
                        ...
                        @if($termo)
                            ...
                            <p class="font-semibold text-slate-700">
                                Sem resultados para "<span class="text-orange-600">{{ $termo }}</span>"
                            </p>
