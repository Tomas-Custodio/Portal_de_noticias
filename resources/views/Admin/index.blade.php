        ...
        <div class="flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
            ...
            <div>
                ...
                <p class="mt-3 max-w-2xl text-sm leading-6 text-slate-500">
                    Gerencie os utilizadores que possuem acesso
    ...
    <div class="grid gap-6 md:grid-cols-3">
        ...
        >
            ...
            <p class="mt-2 text-sm leading-6 text-slate-500">
                Consulte todos os utilizadores cadastrados
        ...
        >
            ...
            <p class="mt-2 text-sm leading-6 text-slate-500">
                Crie uma nova conta e defina o nível
        ...
        >
            ...
            <p class="mt-2 text-sm leading-6 text-slate-500">
                Escolha um utilizador existente e
        ...
        <div class="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm transition duration-300 hover:shadow-md">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        <h2 class="font-bold text-slate-900">Últimos registados</h2>
                        <p class="mt-1 text-sm leading-6 text-slate-500">
                            Os utilizadores mais recentes do sistema.
                        </p>
                    </div>

                </div>

                <a href="{{ route('users.list_users') }}"
            ...
            @if(isset($ultimos_users) && $ultimos_users->count())
